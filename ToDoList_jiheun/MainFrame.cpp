...
void MainFrame::CreateControls()
{
	...
	addButton = new wxButton(panel, wxID_ANY, "추가", wxPoint(600, 80), wxSize(100, 35));

	checkListBox = new wxCheckListBox(panel, wxID_ANY, wxPoint(100, 120), wxSize(600, 400));

	clearButton = new wxButton(panel, wxID_ANY, "비우기", wxPoint(100, 525), wxSize(100, 35));
}
...
void MainFrame::OnClearButtonClicked(wxCommandEvent& evt)
{
	...
	wxMessageDialog dialog(this, "정말 모두 지우시겠습니까?", "모두 지우기", wxYES_NO | wxCANCEL);
